...
![Messy data](dataset/messy_data_snapshot.png){fig-alt="Snapshot of csv file" fig-align="center"}
...
Finally, this is what the final cleaned dataset looked like:

![Clean Dataset](dataset/clean_data_snapshot.png){fig-align="center"}
