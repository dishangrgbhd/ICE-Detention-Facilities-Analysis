...
- `messy_data_snapshot.png`
  Snapshot showing the raw messy data before preprocessing.
...
- `clean_data_snapshot.png`  
  Snapshot showing the final cleaned data after preprocessing.

- `top_10_largest_facilities.png`
...
![Top 10 Largest Detention Facilities](Output/top_10_largest_facilities.png)
