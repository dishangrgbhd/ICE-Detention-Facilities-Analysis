...
path <- "D:/ICE Detention facilities/Ice detention facilities/dataset/messy_ice_detention.csv"
...
write.csv(
  df_clean,
  "D:/ICE Detention facilities/Ice detention facilities/dataset/clean_ice_detention.csv",
  row.names = FALSE
)
